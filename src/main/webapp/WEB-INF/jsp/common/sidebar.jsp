...
<c:set var="isManager"
	value="${sessionScope.isManager != null ? sessionScope.isManager : false}" />
	...
	<nav id="sidebar">
		...
		<div class="nav-group open">
			...
			<div class="nav-group-content">
				<a href="${ctx}/main" class="nav-item">메인 대시보드</a> <a
					href="${ctx}/auth/pw-change" class="nav-item">비밀번호 변경</a> <a
					href="${ctx}/notification" class="nav-item">알림</a>
			</div>
		</div>
		...
		<div class="nav-group">
			<div class="nav-group-header" onclick="toggleAccordion(this)">조직
				관리</div>
			<div class="nav-group-content">
				<a href="${ctx}/org/dept" class="nav-item">부서 관리</a> <a
					href="${ctx}/org/position" class="nav-item">직급 관리</a>
			</div>
		</div>
		...
		<div class="nav-group">
			<div class="nav-group-header" onclick="toggleAccordion(this)">직원
				관리</div>
			<div class="nav-group-content">
				<a href="${ctx}/emp/list" class="nav-item">직원 목록</a> <a
					href="${ctx}/emp/history" class="nav-item">인사발령 이력</a> <a
					href="${ctx}/emp/approvalHistory" class="nav-item">휴직·복직·퇴직 내역</a>
		...
		<div class="nav-group">
			<div class="nav-group-header" onclick="toggleAccordion(this)">근태
				관리</div>
			<div class="nav-group-content">
				<a href="${ctx}/att/record" class="nav-item">출퇴근</a> <a
					href="${ctx}/att/leave/req" class="nav-item">휴가 신청</a> <a
					href="${ctx}/att/overtime/req" class="nav-item">초과근무 신청</a>
		...
		<c:if test="${isSysAdmin}">
			<div class="nav-group">
				...
				<div class="nav-group-content">
					<a href="${ctx}/sys/accountUnlock" class="nav-item">계정 잠금 해제</a> <a
						href="${ctx}/sys/holiday" class="nav-item">공휴일 관리</a> <a
						href="${ctx}/sys/auditLog" class="nav-item">변경 이력 조회</a> <a
						href="${ctx}/sys/passwordReset" class="nav-item">비밀번호 초기화</a> <a
						href="${ctx}/sys/roleChange" class="nav-item">계정 권한 변경</a>
				</div>
			</div>
		</c:if>
		...
		<c:if test="${isSysAdmin || isHrAdmin || isCeo}">
			<div class="nav-group">
				<div class="nav-group-header" onclick="toggleAccordion(this)">데이터
					조회</div>
				<div class="nav-group-content">
