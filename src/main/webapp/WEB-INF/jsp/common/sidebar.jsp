	...
	<nav id="sidebar">
		...
		<div class="nav-group open">
			...
			<div class="nav-group-content">
				<a href="${pageContext.request.contextPath}/main" class="nav-item">메인
					대시보드</a> <a href="${pageContext.request.contextPath}/auth/pw-change"
					class="nav-item">비밀번호 변경</a> <a
		...
		<div class="nav-group">
			<div class="nav-group-header" onclick="toggleAccordion(this)">조직
				관리</div>
			<div class="nav-group-content">
				<a href="${pageContext.request.contextPath}/org/dept"
					class="nav-item">부서 관리</a> <a
					href="${pageContext.request.contextPath}/org/position"
					class="nav-item">직급 관리</a>
			</div>
		</div>
    ...
    <c:set var="isAdmin"
		...
		<div class="nav-group">
			<div class="nav-group-header" onclick="toggleAccordion(this)">근태
				관리</div>
			<div class="nav-group-content">
				<a href="${pageContext.request.contextPath}/att/record"
					class="nav-item">출퇴근</a> <a
					href="${pageContext.request.contextPath}/att/leave/req"
					class="nav-item">휴가 신청</a>
				<c:if test="${isAdmin}">
					<a href="${pageContext.request.contextPath}/att/leave/approve"
						class="nav-item">휴가 승인</a>
				</c:if>
				<a href="${pageContext.request.contextPath}/att/overtime/req"
					class="nav-item">초과근무 신청</a>
				<c:if test="${isAdmin}">
					<a href="${pageContext.request.contextPath}/att/overtime/approve"
						class="nav-item">초과근무 승인</a>
				</c:if>
				<c:if test="${isAdmin}">
      ...
      <div class="nav-group">
		...
		<c:if test="${sessionScope.userRole == '관리자'}">
			<div class="nav-group">
				...
				<div class="nav-group-content">
					<a href="${pageContext.request.contextPath}/sys/accountUnlock"
						class="nav-item">계정 잠금 해제</a> <a
						href="${pageContext.request.contextPath}/sys/holiday"
						class="nav-item">공휴일 관리</a> <a
						href="${pageContext.request.contextPath}/sys/auditLog"
						class="nav-item">변경 이력 조회</a> <a
						href="${pageContext.request.contextPath}/sys/passwordReset"
						class="nav-item">비밀번호 초기화</a> <a
						href="${pageContext.request.contextPath}/sys/roleChange"
						class="nav-item">계정 권한 변경</a> <a
						href="${pageContext.request.contextPath}/sys/sqlQuery"
						class="nav-item">AI 데이터 조회</a>
				</div>
			</div>
		</c:if>
