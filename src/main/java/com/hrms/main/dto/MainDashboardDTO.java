...
public class MainDashboardDTO {
	...
	public void setRecentRequests(List<Map<String, Object>> recentRequests) {
		this.recentRequests = recentRequests;
	}
	public List<Map<String, Object>> getRecentNotifications() {
		return recentNotifications;
	}
	public void setRecentNotifications(List<Map<String, Object>> recentNotifications) {
	...
	public int getPendingOtCount() {
		return pendingOtCount;
	}
	public void setPendingOtCount(int pendingOtCount) {
		this.pendingOtCount = pendingOtCount;
	}
	public List<Map<String, Object>> getPendingLeaves() {
		return pendingLeaves;
	}
	public void setPendingLeaves(List<Map<String, Object>> pendingLeaves) {
		this.pendingLeaves = pendingLeaves;
	}
	public List<Map<String, Object>> getPendingOts() {
		return pendingOts;
	}
	public void setPendingOts(List<Map<String, Object>> pendingOts) {
		this.pendingOts = pendingOts;
	}
	public List<Map<String, Object>> getDeptAttendance() {
		return deptAttendance;
	}
	public void setDeptAttendance(List<Map<String, Object>> deptAttendance) {
		this.deptAttendance = deptAttendance;
	}
	public int getSalaryDoneCount() {
		return salaryDoneCount;
	}
	public void setSalaryDoneCount(int salaryDoneCount) {
		this.salaryDoneCount = salaryDoneCount;
	}
	public int getSalaryTotalCount() {
		return salaryTotalCount;
	}
	public void setSalaryTotalCount(int salaryTotalCount) {
	...
	public int getIncompleteEvalCount() {
		return incompleteEvalCount;
	}
	public void setIncompleteEvalCount(int incompleteEvalCount) {
		this.incompleteEvalCount = incompleteEvalCount;
	}
	public List<Map<String, Object>> getRecentAuditLogs() {
		return recentAuditLogs;
	}
	public void setRecentAuditLogs(List<Map<String, Object>> recentAuditLogs) {
