...
<%-- ============================================================
     공통 경로 및 권한 변수 세팅
     isManager : 로그인 시 세션에 저장된 부서장 여부 플래그 (Boolean)
                 role과 독립적 — HR담당자·일반직원 모두 부서장일 수 있음
     ============================================================ --%>
...
<%-- 근태·결재 승인 그룹: HR담당자 또는 부서장 (관리자 제외) --%>
<c:set var="canApprove" value="${isHrAdmin || isManager}" />
...
<nav id="sidebar">
  ...
  <%-- ──────────────────────────────────────────
       조직 관리 : HR담당자(CRUD), CEO(조회)
       관리자·일반직원·부서장은 메뉴 자체 비노출
       ────────────────────────────────────────── --%>
  <c:if test="${isHrAdmin || isCeo}">
    <div class="nav-group">
  ...
  <%-- ──────────────────────────────────────────
       직원 관리 : 관리자만 제외 (본인 데이터 없음)
       - 직원 목록·이력·퇴직내역 : HR, CEO, 부서장, 일반직원
       - 직원 등록               : HR담당자 전용
       - 휴직·복직·퇴직 승인     : HR, CEO(최종결재), 부서장
       ────────────────────────────────────────── --%>
  ...
  <%-- ──────────────────────────────────────────
       근태 관리 : 전 역할 허용 (관리자는 본인 데이터만)
       - 출퇴근·휴가신청·초과근무신청·연차현황 : 모두
       - 휴가·초과근무 승인 : HR담당자, 부서장 (canApprove)
       - 근태 현황·보정     : HR담당자, CEO(조회)
       - 연차 일괄 부여     : HR담당자 전용
       ────────────────────────────────────────── --%>
  <div class="nav-group">
  ...
  <%-- ──────────────────────────────────────────
       급여 관리
       - 급여 명세서         : 전 역할 허용 (본인 데이터)
       - 급여 계산·지급      : HR담당자 전용
       - 급여 현황·공제율    : HR담당자, CEO(조회)
       ────────────────────────────────────────── --%>
  <div class="nav-group">
  ...
  <%-- ──────────────────────────────────────────
       인사 평가
       - 평가 작성     : CEO 제외 전 역할 (관리자 포함 본인 평가)
       - 평가 현황·확정 : 전 역할 허용
       ────────────────────────────────────────── --%>
  <div class="nav-group">
